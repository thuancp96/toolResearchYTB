...
VOICES = [
    ...
    ("🇰🇷 InJoon — nam, trầm/u ám, kể chuyện tâm linh", "ko-KR-InJoonNeural"),
    ("🇰🇷 Hyunsu — nam, giọng trưởng thành, kể chuyện tâm linh", "ko-KR-HyunsuNeural"),
    ("🇰🇷 BongJin — nam, trầm ấm, Hàn", "ko-KR-BongJinNeural"),
    ("🇰🇷 GookMin — nam, điềm đạm, Hàn", "ko-KR-GookMinNeural"),
